...
| Operations ports reachable today | peers: `9444` (peer0.org1), `9445` (peer1.org1), `9446` (peer0.tenant01), `11446` (peer0.tenant02), `9447` (peer0.org3); orderers: `7071`/`8070`/`9070` (orderer0/1/2.org1; orderer0 moved off 7070 to avoid an AnyDesk port conflict on macOS hosts) | `fabric-network/network/compose/network-docker-compose.yaml` |
